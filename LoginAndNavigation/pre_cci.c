# 1 "d:\\loaruner_scripts\\webtourss\\loginandnavigation\\\\combined_LoginAndNavigation.c"
...
# 1 "d:\\loaruner_scripts\\webtourss\\loginandnavigation\\\\combined_LoginAndNavigation.c" 2
...
# 2 "d:\\loaruner_scripts\\webtourss\\loginandnavigation\\\\combined_LoginAndNavigation.c" 2
...
void ErrorCode(char* transaction ){
	if(atoi(lr_eval_string("{checkpoint}")) >0){
			...
			lr_end_transaction(transaction, 0);
	}
	else{
			lr_end_transaction(transaction, 1);
	}
}
# 3 "d:\\loaruner_scripts\\webtourss\\loginandnavigation\\\\combined_LoginAndNavigation.c" 2
...
# 4 "d:\\loaruner_scripts\\webtourss\\loginandnavigation\\\\combined_LoginAndNavigation.c" 2
...
# 5 "d:\\loaruner_scripts\\webtourss\\loginandnavigation\\\\combined_LoginAndNavigation.c" 2
...
# 6 "d:\\loaruner_scripts\\webtourss\\loginandnavigation\\\\combined_LoginAndNavigation.c" 2
